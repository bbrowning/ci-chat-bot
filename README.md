...
```
make release RELEASE_VERSION=0.0.15 RELEASE_REGISTRY=quay.io/bbrowning/crc-cluster-bot
```
...
```
cat deploy/deployment.yaml | sed -e "s|REPLACE_IMAGE|quay.io/bbrowning/crc-cluster-bot:v0.0.15|g" | oc apply -f -
```
